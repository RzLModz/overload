...
process.argv.length < 7 &&
    (process.argv.length < 7 && console.log('   '),
        ...
        process.argv.length < 7 &&
        console.log(
            '\x1B[0m\x1B[34m[\x1B[1m\x1B[0m!\x1B[0m\x1B[34m]\x1B[1m\x1B[0m\x1B[1m\x1B[0m Made by \x1B[1m\x1B[31m@OverloadServer'
        ),
        process.argv.length < 7 &&
        console.log(
...
const sig = [
    ...
    OverloadServer = Methods[Math.floor(Math.random() * Methods.length)]
